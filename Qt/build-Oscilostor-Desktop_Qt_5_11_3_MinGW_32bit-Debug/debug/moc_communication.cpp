...
#include "../../Oscilostor/communication.h"
...
QT_MOC_LITERAL(1, 14, 14), // "readyToCompute"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4) // "data"

    },
    "Communication\0readyToCompute\0\0data"
};
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readyToCompute((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communication::readyToCompute)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Communication::readyToCompute(QByteArray _t1)
{
